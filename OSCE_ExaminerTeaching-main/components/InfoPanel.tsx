    ...
    <div className="panel fade-in stack">
      ...
      <div style={{
        ...
        <ul style={{ marginTop: "8px", marginBottom: 0, paddingLeft: "20px", lineHeight: 1.8 }}>
          <li><strong>Anamnese und Untersuchung</strong> – wählen Sie eines der verfügbaren Videos</li>
      ...
      <div className="stack" style={{ gap: "20px" }}>
        <Step number={1} title="Video auswählen und anschauen">
          Wählen Sie im linken Menü <strong>je ein Video</strong> pro Station (Anamnese und Untersuchung
