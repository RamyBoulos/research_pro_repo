...
export default function EvaluationPanel({ onComplete }: EvaluationPanelProps) {
  ...
  return (
    <div className="panel fade-in stack">
      ...
      {step === 0 && (
        <p style={{ fontSize: "13px", color: "var(--muted)", lineHeight: 1.6, margin: "0 0 4px", padding: "12px 14px", background: "rgba(0,0,140,0.05)", borderRadius: "10px", border: "1px solid rgba(0,0,140,0.12)" }}>
          Mit dieser Evaluation helfen Sie uns, das <strong>KI-generierte Meta-Feedback</strong> zu bewerten — also die automatische Rückmeldung auf Ihr mündliches Feedback. Bewertet wird weder Ihr Audio-Feedback selbst noch das gezeigte Video.
        </p>
      )}
