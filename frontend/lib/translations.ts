...
>> = {
  ...
  en: [
    { type: "likert", text: "I am satisfied with the feedback.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I find the feedback fair.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I think the feedback was justified.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I find the feedback useful.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I find the feedback helpful.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "The feedback supports me strongly.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I accept the feedback.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I question the feedback.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I reject the feedback.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "I am willing to improve my performance.", low: "strongly disagree", high: "strongly agree" },
    { type: "likert", text: "When I receive this feedback, I feel ... satisfied.", low: "Not at all", high: "Very" },
    { type: "likert", text: "When I receive this feedback, I feel ... confident.", low: "Not at all", high: "Very" },
    { type: "likert", text: "When I receive this feedback, I feel ... successful.", low: "Not at all", high: "Very" },
    { type: "likert", text: "When I receive this feedback, I feel ... offended.", low: "Not at all", high: "Very" },
    { type: "likert", text: "When I receive this feedback, I feel ... annoyed.", low: "Not at all", high: "Very" },
    { type: "likert", text: "When I receive this feedback, I feel ... frustrated.", low: "Not at all", high: "Very" },
